...
export class ProductClient {
    ...
    public async disable(product: Product) : Promise<void> {
        try {
            return (await this.axiosClient.put(`/disable/${product.id}`)).data
        }
        catch(error:any) {
            return Promise.reject(error.response)
        }
    ...
    public async enabled(product: Product) : Promise<void> {
        try {
            return (await this.axiosClient.put(`/enabled/${product.id}`)).data
        }
        catch(error:any) {
            return Promise.reject(error.response)
        }
